...
const SUMMARY_PROMPT = `You are summarizing a Claude Code development session transcript.
...
export async function summarizeSession(notebookId: string): Promise<string> {
